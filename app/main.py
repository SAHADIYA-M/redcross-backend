...
# Configure CORS to permit cross-origin requests from any frontend port/origin
# (including localhost:3000, localhost:5173, 127.0.0.1:3000, cloud run previews, etc.)
app.add_middleware(
    CORSMiddleware,
